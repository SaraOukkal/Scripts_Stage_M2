...
def mut_rates_plots(sub_mut_rates1, sub_mut_rates2, output_dir):
	...
	plt.figure(figsize=(10,10))	
	plt.plot(MR_dist,Smooth_AT1, color="dodgerblue", linestyle="dotted")
	plt.plot(MR_dist,Smooth_TA1, color="green", linestyle="dotted")
	plt.plot(MR_dist,Smooth_AT2, color="dodgerblue")
	...
	plt.figure(figsize=(10,10))	
	plt.plot(MR_dist,Smooth_GT1, color="orange", linestyle="dotted")
	plt.plot(MR_dist,Smooth_CA1, color="red", linestyle="dotted")
