...
def mut_rates_plots(sub_mut_rates1, sub_mut_rates2, output_dir):
	...
	plt.plot(MR_dist,Smooth_AT2, color="dodgerblue", linestyle="loosely dashed")
	plt.plot(MR_dist,Smooth_TA2, color="green", linestyle="loosely dashed")
	plt.axes().minorticks_on()
	plt.axes().tick_params(axis='both', which='major', direction='in', length= 8, width=2)
	plt.axes().tick_params(axis='both', which='minor', direction='in', length= 4, width=1.5)
	plt.axes().xaxis.set_major_locator(MultipleLocator(100))
	...
	plt.plot(MR_dist,Smooth_GT2, color="orange",linestyle="loosely dashed")
	plt.plot(MR_dist,Smooth_CA2, color="red", linestyle="loosely dashed")
	plt.axes().minorticks_on()
	plt.axes().tick_params(axis='both', which='major', direction='in', length= 8, width=2)
	plt.axes().tick_params(axis='both', which='minor', direction='in', length= 4, width=1.5)
	plt.axes().xaxis.set_major_locator(MultipleLocator(100))
