...
def mut_number(input_Mut, output_dir):
	...
	plt.plot(dist,Mutations, color='indigo')
	plt.axvline(0, color='black', alpha=0.5)
	plt.axes().minorticks_on()
	plt.axes().tick_params(axis='both', which='major', direction='in', length= 10, width=2)
	plt.axes().tick_params(axis='both', which='minor', direction='in', length= 5, width=2)
...
def mut_rate_plot(mut_rate, output_dir):
	...
	plt.axes().minorticks_on()
	plt.axes().tick_params(axis='both', which='major', direction='in', length= 6, width=2)
	plt.axes().tick_params(axis='both', which='minor', direction='in', length= 3, width=2)
	plt.axes().xaxis.set_major_locator(MultipleLocator(100))
	plt.axes().xaxis.set_minor_locator(MultipleLocator(50))
	plt.xticks(fontsize=20)
	plt.yticks(fontsize=20)
