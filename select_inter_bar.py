...
def main(): 
	...
	#fichier output:				
	parser.add_argument('-o', '--output_file', type=str, help='Path to output file', default ="/home/saraoukkal/Documents/Stage_M1/Chimp_Step2_results/selected_inter_bar.txt")					
