...
def base_bar(barriers, input_B, Right, Left):
	"""
...
def main(): 
	...
	parser.add_argument('-B', '--input_B', type=str, help='Path to bases', default ="/home/soukkal/Bureau/Projet/Step3_results/AB_chimp.txt")			
